...
/** ATTENTION: Exposing this to improve the hard-fault handler. */
/*
...
typedef struct tskTaskControlBlock
{
	...
	signed char				pcTaskName[ configMAX_TASK_NAME_LEN ];/*< Descriptive name given to the task when created.  Facilitates debugging only. */
		...
		unsigned portBASE_TYPE  uxStackSize;
	#endif
...
typedef struct xTASK_STATUS
{
	...
	unsigned short usStackSize;                 /* Size of the stack in bytes */
} xTaskStatusType;
 ...
 *
 * @param bfr_size The size of the buffer passed in
 *
 * \defgroup vTaskList vTaskList
 * \ingroup TaskUtils
 */
void vTaskList( signed char *pcWriteBuffer, size_t bfr_size ) PRIVILEGED_FUNCTION;
